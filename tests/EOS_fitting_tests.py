...
class EOSparametrizationTestCase(unittest.TestCase):
    ...
    def test_EOS_EAM_Al_fcc_fitting(self):
        ...
        cutoff = 5.
        number_of_neighbor_levels = 3
        eos_Morse = EAM(formula, primitive_cell, basis_vectors, cutoff, number_of_neighbor_levels, units='J/mol')
        initial_parameters = np.array([3.601752881e-01, 1.090829630e+00, 1.098542954e+00, 1.012121606e+00, 1.004830571e+00, 1.519642057e+00, 1.883696186e-01, 1.103658726e+00, 9.722673674e-01, 1.502896332e+00])

        eos_Morse.fitEOS(V_DFT, E_DFT, initial_parameters=initial_parameters)

        bool_1 = None == np.testing.assert_array_almost_equal(eos_Morse.pEOS, np.array([1.864283e-02, 1.087716e+00, 1.267761e+00, 1.016616e+00, 1.005353e+00, 2.981997e+00, 2.563705e-07, 1.105120e+00,1.815219e+00, 1.493627e+00]))
