...
class GenerateCellCoordinatesTestCase(unittest.TestCase):
    ...
    def test_nl_0(self):
        ...
        result = pa_calc.neighbor_list(self.size(1),self.basis_vectors,self.primitive_cell(1), 2)
    ...
    def test_pa_1(self):
        ...
        distances, num_bonds_per_formula, combs_types = pa_calc.pair_analysis(formula, cutoff, basis_vectors, primitive_cell)
